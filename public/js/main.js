...
var EmailField = React.createClass({
    ...
    render: function () {
        var formClass = this.state.valid ? "form-group" : "form-group has-danger";
        return React.createElement(
            "div",
            { className: formClass },
            React.createElement("input", { type: "email", className: "form-control", onChange: this.onChange, placeholder: "Email", value: this.state.value })
        );
    }
});
...
var NameField = React.createClass({
    ...
    render: function () {
        return React.createElement(
            ...
            React.createElement("input", { type: "text", className: "form-control", onChange: this.onChange, placeholder: this.props.type + " Name", value: this.state.value })
        );
    }
});
